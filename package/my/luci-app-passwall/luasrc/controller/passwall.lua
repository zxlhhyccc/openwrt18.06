...
function index()
    ...
    entry({"admin", "vpn", "passwall", "subscription"},cbi("passwall/subscription"), _("Subscription Managenent"),4).leaf = true
    entry({"admin", "vpn", "passwall", "auto_switch"},
          cbi("passwall/auto_switch"), _("Auto Switch"), 5).leaf = true
